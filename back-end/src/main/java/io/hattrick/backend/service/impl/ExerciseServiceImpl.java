...
import io.hattrick.backend.repository.ExerciseRepository;
...
public class ExerciseServiceImpl implements ExerciseService {
    ...
    public EmptyResponse updateExercise(UpdateExerciseRequest request, UserEntity user) {
        ...
        exerciseEntity.setFootballGroup(request.footballGroup());
        exerciseEntity.setRoleType(request.roleType());
